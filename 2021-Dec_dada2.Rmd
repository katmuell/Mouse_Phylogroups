...
Filter reads
```{r}
filt.out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, trimLeft = 10, truncLen = c(245,190),
...
```{r}
seqtab2 <- seqtab[, nchar(colnames(seqtab)) %in% seq(210,280)]
```
