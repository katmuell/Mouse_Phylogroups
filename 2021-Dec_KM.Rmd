...
just.katherine.ps <- all_mice.ps %>%
  ...
  subset_samples(!SampleName %in% c("C1M1_ileum_lumen", "C1M1_ileum_tissue", "C2M2_ileum_lumen", "C2M2_ileum_tissue", "C5M1_ileum_lumen", "C5M2_ileum_tissue", "C6M1_colon_lumen", "C6M1_ileum_lumen", "C6M1_ileum_tissue"))
just.katherine.ps
```
...
```{r}
cb.1616.legend <- custom_legend(mdf.BAA, cdf.BAA, legend_text_size = 15)
